 ...
 */
final class Version20230605125611 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ordinateur ADD boitier_id INT NOT NULL, ADD cm_id INT NOT NULL, ADD gpu_id INT NOT NULL, ADD hdd_id INT NOT NULL, ADD processeur_id INT NOT NULL, ADD ram_id INT NOT NULL, ADD refroidisseur_id INT NOT NULL, ADD ssd_id INT NOT NULL');
        $this->addSql('ALTER TABLE ordinateur ADD CONSTRAINT FK_8712E8DB44DE6F7C FOREIGN KEY (boitier_id) REFERENCES boitier (id)');
        $this->addSql('ALTER TABLE ordinateur ADD CONSTRAINT FK_8712E8DB48FCC97C FOREIGN KEY (cm_id) REFERENCES cm (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ordinateur DROP boitier_id, DROP cm_id, DROP gpu_id, DROP hdd_id, DROP processeur_id, DROP ram_id, DROP refroidisseur_id, DROP ssd_id');
    }
}
